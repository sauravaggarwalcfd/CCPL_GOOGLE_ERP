 ...
 *   fields   — per-key metadata: ico, fk (FK target key), hint, fieldType
 *
...
export const FIELD_META = {
  ...
  article_master: {
    ...
    fields: {
      ...
      gender:      { ico: "⚠",  hint: "Men / Women / Kids / Unisex." },
      fitType:     { ico: "—",  hint: "Regular / Slim / Relaxed / Oversized." },
      neckline:    { ico: "—",  hint: "Round / V-Neck / Collar / Hooded." },
      sleeveType:  { ico: "—",  hint: "Half / Full / Sleeveless / 3/4." },
      ...
      colorCodes:  { ico: "⟷",  fk: "color_master", hint: "Multi-select. Comma-separated color codes.", fieldType: "multifk" },
      sizeRange:   { ico: "—",  hint: "Display: S-M-L-XL-XXL." },
      ...
      hsnCode:     { ico: "→",  fk: "hsn_master", hint: "4 or 8-digit HSN. Mandatory.", fieldType: "fk" },
      gstPct:      { ico: "←",  hint: "← Auto from HSN_MASTER.", fieldType: "auto" },
      status:      { ico: "⚠",  hint: "Active / Development / Inactive." },
  ...
  rm_fabric: {
    ...
    fields: {
      ...
      yarnComp:     { ico: "⟷",  fk: "rm_yarn", hint: "Multi-select yarn codes.", fieldType: "multifk" },
      yarnNames:    { ico: "←",  hint: "← Auto from RM_MASTER_YARN.", fieldType: "auto" },
      fabricType:   { ico: "⚠",  hint: "KORA / FINISHED." },
      colour:       { ico: "—",  hint: "KORA / COLOURED / DYED / MÉLANGE." },
  ...
  rm_yarn: {
    ...
    fields: {
      ...
      colourType:  { ico: "—",  hint: "Raw White / Dyed / Mélange / Grindle." },
      ...
      status:      { ico: "⚠",  hint: "Active / Inactive." },
  ...
  trim_master: {
    ...
    fields: {
      ...
      category:    { ico: "⚠",  hint: "THD/LBL/ELS/ZIP/BUT/TPE/DRW/VLC/RVT/THP/OTH." },
      ...
      uom:         { ico: "⚠",  hint: "CONE/MTR/PCS/KG/SET/ROLL." },
  ...
  consumable_master: {
    ...
    fields: {
      ...
      category:    { ico: "⚠",  hint: "DYE/CHM/NDL/OIL/PKG/OTH." },
  ...
  packaging_master: {
    ...
    fields: {
      ...
      category:    { ico: "⚠",  hint: "PLY/CTN/HGR/TKT/STK/OTH." },
  ...
  color_master: {
    ...
    fields: {
      ...
      family:  { ico: "—",  hint: "Blues/Reds/Neutrals/Whites/Blacks." },
      active:  { ico: "—",  hint: "Yes / No." },
    },
  },
