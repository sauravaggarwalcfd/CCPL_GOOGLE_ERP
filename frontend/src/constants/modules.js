export const MODS = [
  ...
  {id:"inventory",  icon:"🗄️",lbl:"Inventory",   badge:0, desc:"Ledger · Movements · Issue", col:"#007C7C",stats:null, sub:[{icon:"📊",lbl:"Stock Ledger",sid:"ledger"},{icon:"🔄",lbl:"Stock Movements",sid:"movement"},{icon:"📤",lbl:"Stock Issue",sid:"issue"},{icon:"🚛",lbl:"Stock Transfer",sid:"transfer"},{icon:"📋",lbl:"Stock Adjustments",sid:"adjust"}]},
