...
export const SCHEMA_ARTICLE_MASTER = [
  ...
  { key:"imageLink",  header:"IMAGE LINK",              label:"Image Link",    w:"110px", type:"url", thumb:true },
  { key:"sketchLink", header:"⟷ SKETCH DRIVE LINKS",   label:"Sketch Link",   w:"120px", thumb:true, multi:true },
...
export const SCHEMA_RM_FABRIC = [
  ...
  { key:"l1Division",   header:"L1 Division",            label:"L1 Division",   w:"100px", auto:true },
  { key:"l2Category",   header:"L2 Category",            label:"L2 Category",   w:"100px", auto:true },
  { key:"knitName",     header:"L3 Knit Type",           label:"Knit Type",     w:"1fr",   required:true },
  { key:"imageLink",    header:"IMAGE LINK",             label:"Image Link",    w:"110px", type:"url",  thumb:true },
  { key:"yarnComp",     header:"↔ YARN COMPOSITION",     label:"Yarn Comp",     w:"120px", auto:true },
  { key:"yarnNames",    header:"← Yarn Names",           label:"Yarn Names",    w:"120px" },
...
export const SCHEMA_SPARE_PARTS_MASTER = [
  ...
  { key:"name",         header:"⚠ Spare Part Name",          label:"Part Name",   w:"1fr",   required:true },
